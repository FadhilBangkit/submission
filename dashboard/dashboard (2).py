...
if dataset_choice == 'Data Harian':
  ...
  st.markdown(
    """
    ## 1. Kondisi lingkungan (weathersit)
    """
  ...
  st.markdown("""
    ...
    <div class="text-box">
    Dalam analisis data yang telah lakukan, ditemukan adanya korelasi negatif yang signifikan antara variabel weathersit dan jumlah pengguna sepeda. Korelasi negatif ini menunjukkan bahwa ketika kondisi cuaca memburuk, jumlah pengguna sepeda cenderung menurun.
    </div>
    """, unsafe_allow_html=True)
  st.markdown(
    """
  ...
  st.markdown("""
    ...
    <div class="text-box">
    Analisis data yang telah dilakukan menunjukkan adanya korelasi negatif yang signifikan antara variabel kelembapan (hum) dan jumlah pengguna sepeda. Korelasi negatif ini menandakan bahwa ketika tingkat kelembapan meningkat, jumlah pengguna sepeda cenderung menurun.
    </div>
    """, unsafe_allow_html=True)
  st.text(' ')    
  st.markdown("""
    ...
    <div class="text-box">
    Dalam analisis data yang kami lakukan, ditemukan bahwa bukan hanya suhu yang dirasakan yang berpengaruh, tetapi juga suhu lingkungan berkorelasi positif terhadap jumlah pengguna sepeda. Dari kedua data ini, dapat disimpulkan bahwa suhu merupakan faktor terbesar yang memengaruhi keputusan orang untuk bersepeda. Ketika suhu meningkat, baik suhu yang dirasakan maupun suhu lingkungan, semakin banyak orang cenderung memilih bersepeda sebagai aktivitas mereka. Namun, kelembapan (hum) menunjukkan korelasi negatif dengan jumlah pengguna sepeda, di mana peningkatan kelembapan cenderung mengurangi jumlah pengguna. Hal ini memberikan wawasan penting bagi pengelola layanan penyewaan sepeda untuk mengantisipasi permintaan.
    </div>
    """, unsafe_allow_html=True)
  ...
  st.markdown("""
  *Nilai atempt dan temp memiliki nilai tertinggi dalam korelasi sedangkan nilai weathersit dan nilai hum merupakan nilai terendah*
  """)
  ...
  c= plt.figure(figsize=(8, 8), facecolor='#262730')
  ...
  d=plt.figure(figsize=(8, 6), facecolor='#262730') 
  ax = plt.gca()
  ...
  st.markdown("""
    ...
    <div class="text-box">
    Berdasarkan analisis ini, terlihat bahwa suhu memiliki dampak yang lebih besar dibandingkan kelembapan dalam mempengaruhi keputusan untuk bersepeda. Dalam situasi di mana suhu meningkat, meskipun kelembapan juga tinggi, pengaruh positif dari suhu tetap mendominasi.
    </div>
    """, unsafe_allow_html=True)
  st.text('')
  st.write(bike_hour_df_relevant_q1.corr()['cnt'].sort_values(ascending=False))
  st.markdown("""
  *Nilai jam hr merupakan nilai tertinggi dan atemp pada urutan ketiga dan nilai kelembapan memiliki nilai yang kecil*
  """)
  ...
  g = plt.figure(figsize=(8, 8), facecolor='#262730') 
  ax = plt.gca()  
  ax.set_facecolor('#262730') 
  ...
  h = plt.figure(figsize=(8, 6), facecolor='#262730')  
  ax = plt.gca()
  ax.set_facecolor('#262730')  
